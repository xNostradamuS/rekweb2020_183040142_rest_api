  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div clas="container">
            ...
            <button class="navbar-toggler" type="button" data-toggle="cillapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-table="Toggle nacigation">
